# -*- coding: utf-8 -*-
"""
train_module_controller_vae.py

- flatten を廃止して Global Average Pooling を導入
- Encoder を VAE として訓練し、潜在空間でドメインギャップを吸収
- 再構成 + KL + 電圧回帰 MSE のマルチタスク学習
- total / rec / kl / reg をログ＆可視化
- 元画像 / 再構成画像のグリッドを定期的に保存
"""
...
LOG_DIR = r"C:\Users\ishiz\Documents\Akamine_workspace\master_thesis_2025\SMR_control\module_controller\FF\logs_vae"
