...
- ROI後の画像を入力として、ランダムな「回転＋平行移動」を NUM_SAMPLES 枚生成する
- 出力画像の解像度は元画像と同じ (W, H)
- 元画像のファイル名 (例: 57.png) を保持したまま、
  57_aug_0000.png〜57_aug_00xx.png の形で保存する
...
OUT_DIR = r"C:\Users\ishiz\Documents\Akamine_workspace\master_thesis_2025\SMR_control\module_controller\FF\1module_dataset_max_DAC\silicon\roi_aug_rot_shift"
